...
public class TestTask1ProductContainer {
    ...
    public void shouldCorrectReturnIterator() {
        ...
        products.add(expected);
        products.add(new Product("test", new BigDecimal("13"), "uk"));
        Iterator<Product> it = products.logicIterator((p) -> p.getPrice().remainder(new BigDecimal("2")).equals(new BigDecimal("1")));
    ...
    public void shouldCorrectIteratorHasNext() {
        ...
        it = products.logicIterator((p) -> p.getPrice().remainder(new BigDecimal("3")).equals(new BigDecimal("0")));
